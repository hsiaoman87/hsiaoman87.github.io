var resume = {
  ...
  work_history: [
    ...
    },
    {
      ...
      descriptions: [
        ...
        'Submitted and filed patent: <a href="https://www.google.com/patents/US20140279903" target="_blank">Version control system using commit manifest database tables</a>'
      ]
    },
    {
      title: 'SDE Intern',
  ...
  projects: [{
    homepage: 'http://www.lawrencechenfilms.com',
    name: 'lawrencechenfilms.com',
    description: 'Portfolio site for director Lawrence Chen'
  },
  {
    github: 'https://api.github.com/repos/hsiaoman87/mafia'
  },
  {
    github: 'https://api.github.com/repos/hsiaoman87/oomami'
  },
  {
    github: 'https://api.github.com/repos/hsiaoman87/2048'
  }],
  education: {
    school: 'Duke University',
    location: 'Durham, NC',
    degrees: [{
      long: 'Bachelor of Science in Computer Science',
      short: 'BSE in Computer Science'
    },
    {
      long: 'Bachelor of Science in Electrical & Computer Engineering',
      short: 'BSE in Electrical & Computer Engineering'
    }],
    dates: '2005-2009',
    end_date: 'May 2009'
  },
  interests: ['Board Games', 'Cooking', 'Hiking']
}
